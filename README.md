...
Build history and planned modernization work live in [`ROADMAP.md`](./ROADMAP.md). Coding-agent rules live in [`AGENTS.md`](./AGENTS.md); assistant orientation (code map and commands) lives in [`CLAUDE.md`](./CLAUDE.md).
